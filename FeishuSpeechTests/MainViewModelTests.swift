...
final class MainViewModelTests: XCTestCase {
    ...
    func test_willSleep_abortsStreamingWithoutNormalFinishAndReturnsIdle() async {
        ...
        XCTAssertFalse(recorder.stopRecordingCalled, "sleep cleanup must not enter the legacy whole-file path")
    }
